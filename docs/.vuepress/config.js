...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'kongen', // 必需
      link: 'https://github.com/kongenen' // 可选的
    },
    blogger:{ // 博主信息，显示在首页侧边栏
      avatar: '/vdoingBlog/image/1.jpg',
      name: 'Kongen',
      slogan: '你好呀(✪ω✪)'
    },
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'Kongen | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
    htmlModules
  },
  plugins: [ // 插件
